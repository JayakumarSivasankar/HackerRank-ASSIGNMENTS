...
/*
 * Maximum possible sub-array with given 'K' number of odd numbers
 * **/

public class SmallestSubArray {
	
	int count =0;
	public static Set<List<Integer>>  s = new HashSet<>();
	...
	int k=2;
	SmallestSubArray subArray = new SmallestSubArray();
